...
/*
 * This function will be called by cifs_atomic_open() and cifs_create() and the
 * following are the dentry states
 *
 * cifs_atomic_open()
...
/*
 * These are the dentry states when this function gets called
 *
